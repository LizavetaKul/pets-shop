...
const section = document.querySelector('#shop-items');
...
for (let i = 0; i < items.length; i++) {
    section.append(makeCardByTemplate(items[i].title, items[i].description, items[i].tags, items[i].price, items[i].img));
}